...
static const int64 MAX_MONEY = 38000000 * COIN; // AffiCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 1) / 250; // AffiCoin: Priority cutoff is 2 AffiCoin day / 250 bytes.
    }
